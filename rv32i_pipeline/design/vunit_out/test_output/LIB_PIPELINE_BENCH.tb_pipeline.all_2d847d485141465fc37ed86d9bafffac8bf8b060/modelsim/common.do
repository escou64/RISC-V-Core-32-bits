...
proc vunit_load {{vsim_extra_args ""}} {
    set vsim_failed [catch {
        eval vsim ${vsim_extra_args} {-modelsimini /media/data/Projects/RISC-V-Core-32-bits/rv32i_pipeline/design/vunit_out/modelsim/modelsim.ini -wlf {/media/data/Projects/RISC-V-Core-32-bits/rv32i_pipeline/design/vunit_out/test_output/LIB_PIPELINE_BENCH.tb_pipeline.all_2d847d485141465fc37ed86d9bafffac8bf8b060/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_pipeline/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : /media/data/Projects/RISC-V-Core-32-bits/rv32i_pipeline/design/vunit_out/test_output/LIB_PIPELINE_BENCH.tb_pipeline.all_2d847d485141465fc37ed86d9bafffac8bf8b060/,tb path : /media/data/Projects/RISC-V-Core-32-bits/rv32i_pipeline/design/bench/"} LIB_PIPELINE_BENCH.tb_pipeline(bench_arch)   -L vunit_lib -L osvvm -L LIB_PIPELINE -L LIB_PIPELINE_BENCH}
    }]

    if {${vsim_failed}} {
       echo Command 'vsim ${vsim_extra_args} -modelsimini /media/data/Projects/RISC-V-Core-32-bits/rv32i_pipeline/design/vunit_out/modelsim/modelsim.ini -wlf {/media/data/Projects/RISC-V-Core-32-bits/rv32i_pipeline/design/vunit_out/test_output/LIB_PIPELINE_BENCH.tb_pipeline.all_2d847d485141465fc37ed86d9bafffac8bf8b060/modelsim/vsim.wlf} -quiet -t ps -onfinish stop  -g/tb_pipeline/runner_cfg={"active python runner : true,enabled_test_cases : ,output path : /media/data/Projects/RISC-V-Core-32-bits/rv32i_pipeline/design/vunit_out/test_output/LIB_PIPELINE_BENCH.tb_pipeline.all_2d847d485141465fc37ed86d9bafffac8bf8b060/,tb path : /media/data/Projects/RISC-V-Core-32-bits/rv32i_pipeline/design/bench/"} LIB_PIPELINE_BENCH.tb_pipeline(bench_arch)   -L vunit_lib -L osvvm -L LIB_PIPELINE -L LIB_PIPELINE_BENCH' failed
