...
architecture bench_arch of tb_fetch is
	component fetch port (	i_rstn				: in std_logic;										-- Asynhronous Negative Reset
	...
	begin
		fetch1 : fetch port map (				i_rstn				=> s_rstn,							-- Module fetch1
												i_clk				=> s_clk,							-- Connection signal with input/output
												i_pc				=> s_calc_pc,
												i_data				=> s_imem_idata,
												i_jump				=> s_exec_jump,
